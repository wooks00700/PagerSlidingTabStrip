...
public class QuickContactFragment extends DialogFragment {
    ...
    public static class ContactPagerAdapter extends PagerAdapter implements CustomTabProvider {
        ...
        @Override
        public boolean setSelectedTabTypeface(TextView textView) {
            return false;
        }

        @Override
        public boolean setSelectedTextColor(TextView textView) {
            return false;
        }

        @Override
        public boolean setNotSelectedTextColor(TextView textView) {
            return false;
        }

        @Override
        public boolean setNotSelectedTabTypeface(TextView textView) {
            return false;
        }
    }
}
